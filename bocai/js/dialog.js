var dialog = {
    ...
    load: function (a) {
        ...
        dialog._show("", '<div class="icon"><img src="img/loading.gif"></img></div>' + dialog._getHTML(a), {})
    },
    info: function (c, a, b) {
        if (a == null) {
            a = ""
    ...
    alert: function (c, a, b, d) {
        ...
        dialog._show(c, '<div class="icon"><img src="img/success.png"></img></div>' + dialog._getHTML(a), b)
    },
    ...
    error: function (c, a, b) {
        ...
        dialog._show(c, '<div class="icon"><img src="img/error.png" width="32px" height="32px"></img></div>' + dialog._getHTML(a), b)
    },
    confirm: function (c, a, b) {
        ...
        dialog._show(c, '<div class="icon"><img src="img/prompt.png" width="32px" height="32px"></img></div>' + dialog._getHTML(a), b)
    },
